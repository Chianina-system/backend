...
#ifndef COMP_GRAPHSTORE_GRAPHSTORE_CACHE_H_
#define COMP_GRAPHSTORE_GRAPHSTORE_CACHE_H_
...
class GraphStore_cache: public GraphStore{

	friend std::ostream & operator<<(std::ostream & strm, GraphStore_cache& graphstore) {
		strm << "Graphstore<<<<\n============================================" << endl;
...
public:
    GraphStore_cache(bool f_mode, bool buffered_m){
    	file_mode = f_mode;
    	buffered_mode = buffered_m;
    }

    virtual ~GraphStore_cache(){};
...
#endif /* COMP_GRAPHSTORE_GRAPHSTORE_CACHE_H_ */
