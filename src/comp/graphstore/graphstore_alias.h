...
#ifndef COMP_GRAPHSTORE_GRAPHSTORE_ALIAS_H_
#define COMP_GRAPHSTORE_GRAPHSTORE_ALIAS_H_
...
class GraphStore_alias: public GraphStore {

	friend std::ostream & operator<<(std::ostream & strm, GraphStore_alias& graphstore) {
		strm << "Graphstore<<<<\n============================================" << endl;
...
public:
    GraphStore_alias(bool f_mode, bool buffered_m){
    	file_mode = f_mode;
    	buffered_mode = buffered_m;
    }

    virtual ~GraphStore_alias(){};
    ...
    void update_graphs(GraphStore_alias* another, bool update_mode){
    	//for debugging
...
#endif /* COMP_GRAPHSTORE_GRAPHSTORE_ALIAS_H_ */
