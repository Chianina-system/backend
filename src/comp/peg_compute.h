...
public:
    static long startCompute_add(ComputationSet *compset,Grammar *grammar, Timer_wrapper* timer);
    static long startCompute_delete(ComputationSet *compset, Grammar *grammar, std::unordered_map<vertexid_t, EdgeArray> *m);

    static long computeOneVertex(vertexid_t index, ComputationSet *compset, Grammar *grammar, Timer_wrapper* timer = nullptr);

    static void computeOneIteration(ComputationSet *compset,Grammar *grammar, Timer_wrapper* timer = nullptr);
